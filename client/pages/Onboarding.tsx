  ...
  return (
    <div className="h-screen bg-white flex overflow-hidden">
      ...
      <div className="w-full lg:w-[549px] bg-white flex flex-col relative">
        {/* Header */}
        <div className="flex items-center justify-between px-6 lg:px-[65px] pt-6 lg:pt-[24px]">
          {/* Logo */}
        ...
        {/* Main Content */}
        <div
          className={`flex-1 px-6 lg:px-[65px] transition-opacity duration-300 ${isTransitioning ? "opacity-0" : "opacity-100"} ${
          ...
          {currentStep === "selection" && (
            <>
              ...
              <div className="mb-[61px]">
                ...
                <p className="text-[13.8px] text-[rgba(0,2,15,0.5)] font-poppins leading-[21.1px] w-[417px]">
              ...
              <button
                ...
                className="w-[428px] h-[42px] bg-[#10B981] rounded-[7.588px] border border-[#10B981] text-white font-inter text-[14.037px] font-medium transition-all duration-200 hover:bg-[#0ea571] disabled:opacity-50 disabled:cursor-not-allowed mb-[57px]"
              >
                Continue
              </button>
            </>
          ...
          {currentStep === "exhibitor-details" && (
            <>
              ...
              <button
                ...
                className="w-[403px] h-[42px] bg-[#10B981] rounded-[7.588px] border border-[#10B981] text-white font-inter text-[14.037px] font-medium transition-all duration-200 hover:bg-[#0ea571] disabled:opacity-50 disabled:cursor-not-allowed mb-[57px]"
              >
        ...
        {/* Progress Indicators */}
        <div className="flex items-center gap-[9px] px-[64px] pb-[46px] justify-center">
          <div
