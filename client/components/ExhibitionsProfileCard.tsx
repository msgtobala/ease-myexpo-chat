  ...
  return (
    <div className="w-full bg-white rounded-[16px] shadow-[0_20px_60px_0_rgba(241,244,248,0.5)] relative">
      ...
      <img
        ...
        className="absolute left-6 top-[160px] w-[170px] h-[161px] rounded-full border-[5px] border-white object-cover"
      />
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            <div className="flex-1 lg:ml-[190px]">
              ...
              <div className="flex flex-col gap-2 max-w-[479px] mb-4">
                  ...
                  {exhibitionData?.joined_profile ? (
                    <div className="flex items-center relative">
                      ...
                      {Object.keys(exhibitionData.joined_profile).length >
                        5 && (
                        <div className="w-5 h-5 rounded-full bg-[#10B981] border-2 border-white flex items-center justify-center -ml-2 relative">
                          <span className="text-white text-[8px] font-poppins font-medium">
                            +
                            {Object.keys(exhibitionData.joined_profile).length -
                              5}
                          </span>
            ...
            <div className="flex flex-col gap-4 lg:gap-6 lg:items-end lg:min-w-fit">
              ...
              <div className="flex">
                <button
                  ...
                  className={`flex items-center justify-center px-[33px] py-[7px] rounded-[18px] min-h-[31px] min-w-[99px] transition-colors ${
                    isUserJoined
      ...
      <div className="flex items-start justify-between px-6 pt-4">
        ...
        <div className="relative pb-2">
          <button
            onClick={() => onTabChange("product-launches")}
            className="text-left"
          >
            <span
              className={`font-poppins text-[14px] ${
        ...
        <div className="relative pb-2">
          <button onClick={() => onTabChange("settings")} className="text-left">
            <span
              className={`font-poppins text-[14px] ${
                activeTab === "settings"
                  ? "text-[#10B981] font-semibold"
