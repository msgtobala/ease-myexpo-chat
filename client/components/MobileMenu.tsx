...
export default function MobileMenu({ isOpen, onClose, activeItem = 'discussions', onItemClick }: MobileMenuProps) {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Sidebar */}
      <div className={`fixed left-0 top-0 h-full w-[280px] bg-white z-50 transform transition-transform duration-300 ease-in-out lg:hidden flex flex-col ${
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="flex flex-col p-4 space-y-4">
            ...
            <div 
              className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer ${
                activeItem === 'discussions' ? 'bg-[#F0FDF4]' : 'hover:bg-gray-50'
              }`}
            ...
            <div 
              className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer ${
                activeItem === 'smart-match' ? 'bg-[#F0FDF4]' : 'hover:bg-gray-50'
              }`}
            ...
            <div 
              className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer ${
                activeItem === 'popular' ? 'bg-[#F0FDF4]' : 'hover:bg-gray-50'
              }`}
            ...
            <div 
              className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer ${
                activeItem === 'communities' ? 'bg-[#F0FDF4]' : 'hover:bg-gray-50'
              }`}
            ...
            <div 
              className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer ${
                activeItem === 'settings' ? 'bg-[#F0FDF4]' : 'hover:bg-gray-50'
              }`}
          ...
          <div className="mt-6 px-4 pb-4">
            <h3 className="text-[14px] font-semibold text-black mb-4">People you may know</h3>
            <div className="space-y-3">
              <div onClick={handleJoinClick} className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                <img
                ...
                />
                <div>
                  <p className="text-[12px] font-medium text-black">Steve Jobs</p>
                  <p className="text-[10px] text-gray-600">CEO at Apple Inc</p>
                </div>
              </div>
              <div onClick={handleJoinClick} className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                <img
                  src="https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=800&auto=format&fit=crop"
                  alt="Ryan Rickleton"
                  className="w-8 h-8 rounded-full object-cover"
                />
                <div>
                  <p className="text-[12px] font-medium text-black">Ryan Rickleton</p>
                  <p className="text-[10px] text-gray-600">Tech Innovator</p>
                </div>
              </div>
            </div>
          </div>
