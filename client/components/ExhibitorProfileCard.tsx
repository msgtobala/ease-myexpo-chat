  ...
  return (
    <div className="w-full bg-white rounded-[16px] shadow-[0_20px_60px_0_rgba(241,244,248,0.5)] relative">
      ...
      <img
        ...
        className="absolute left-4 top-[160px] w-[174px] h-[161px] rounded-full border-[5px] border-white object-cover"
      />

      {/* Content */}
      <div className="pt-[100px] px-4 lg:px-6 pb-6">
        <div className="flex flex-col gap-4">
          {/* Profile Info */}
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            <div className="flex-1 lg:ml-[190px]">
              {/* Exhibitor Badge */}
              <div className="inline-flex items-center gap-1 px-[7px] py-[5px] rounded-[7px] bg-[rgba(16,185,129,0.25)] mb-2">
                ...
                <span className="text-[#10B981] font-poppins text-[8px] font-bold leading-[11px] tracking-[-0.08px]">
                  Exhibitor
                </span>
              </div>

              {/* Company Name and Description */}
              <div className="flex flex-col gap-2 max-w-[479px]">
                <h2 className="text-[#10B981] font-poppins text-[18px] font-semibold">
                  {userData?.companyName || userData?.name || "Easemyexpo"}
                </h2>
                <p className="text-[#212121] font-poppins text-[14px] leading-[1.5]">
            ...
            <div className="flex flex-col gap-4 lg:gap-6 lg:items-end lg:min-w-fit">
              {/* Location */}
              <div className="flex items-center gap-2 lg:justify-end">
                ...
                <span className="text-[#212121] font-poppins text-[12px] leading-[1.5]">
              ...
              <div className="flex gap-3">
                <button className="flex items-center justify-center px-[31px] py-[6px] border border-[#10B981] rounded-[12px] bg-white min-h-[31px]">
                  <span className="text-[#10B981] font-poppins text-[12px] font-medium text-center">
                    Request Catalogue
                  </span>
                </button>
                {!isOwnProfile && (
                  <button className="flex items-center justify-center px-[16px] py-[6px] rounded-[12px] bg-[#10B981] min-h-[31px] min-w-[125px]">
                    <span className="text-white font-poppins text-[12px] font-medium text-center">
                      Send Message
                    </span>
                  </button>
                )}
                {isOwnProfile && (
                  <button
                    className="flex items-center justify-center px-[16px] py-[6px] rounded-[12px] bg-[#10B981] min-h-[31px] min-w-[125px] hover:bg-[#0ea574] transition-colors"
      ...
      {/* Navigation Tabs */}
      <div className="flex items-start gap-[50px] px-6 pt-4">
        <div className="relative pb-2 w-[151px]">
          <div className="pl-9">
            <span className="text-[#10B981] font-poppins text-[14px] font-semibold">
              Discussion
            </span>
          </div>
          <div className="absolute bottom-0 left-0 w-[151px] h-[2px] bg-[#10B981]"></div>
        </div>
        <div className="pb-2">
          <span className="text-[#212121] font-poppins text-[14px] font-medium">
            Portfolio
          </span>
        </div>
      </div>
