...
export default function Header({ onMenuToggle }: HeaderProps) {
  ...
  return (
    <header className="w-full h-[76px] bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-6">
      ...
      <div className="flex items-center gap-3 lg:gap-6">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-1 -right-1 w-[14px] h-[14px] lg:w-[16px] lg:h-[16px] bg-[#10B981] border border-white rounded-full flex items-center justify-center">
            <span className="text-white text-[10px] lg:text-[11px] font-normal">
              6
            </span>
          </div>
