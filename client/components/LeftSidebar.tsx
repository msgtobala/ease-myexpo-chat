    ...
    <div className="w-full h-[265px] bg-[#FCFDFD] rounded-[16px] p-4 lg:p-6 relative">
      ...
      <div className="flex flex-col gap-4 lg:gap-6">
        ...
        >
          ...
          <span
            className={`text-[16px] font-normal ${activeItem === "discussions" ? "text-[#10B981]" : "text-[#666666]"}`}
          >
            Discussions
          </span>
        </div>
        ...
        >
          ...
          >
            <path
              d="M2.30273 18L9.05273 11.25L13.3587 15.556C14.6037 13.1022 16.6573 11.1531 19.1727 10.038L21.9127 8.818M21.9127 8.818L15.9727 6.537M21.9127 8.818L19.6327 14.758"
              stroke={activeItem === "popular" ? "#10B981" : "#666666"}
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          ...
          <span
            className={`text-[16px] font-normal ${activeItem === "popular" ? "text-[#10B981]" : "text-[#666666]"}`}
          >
            Popular
          </span>
        </div>
        ...
        >
          ...
          <span
            className={`text-[16px] font-normal ${activeItem === "communities" ? "text-[#10B981]" : "text-[#666666]"}`}
          >
            Communities
          </span>
        </div>
        ...
        >
          ...
          <span
            className={`text-[16px] font-normal ${activeItem === "smart-match" ? "text-[#10B981]" : "text-[#666666]"}`}
          >
            Smart Match
          </span>
        </div>
